...
## 8. Verification
To verify your setup, run the integrated test suite:
```bash
# Ensure your Deephaven container is running, then:
python3 -m pytest tests/test_store.py tests/test_timeseries.py tests/test_lakehouse.py
```
