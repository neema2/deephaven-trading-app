...
REGISTRY.define("curve", object,
    description="Cross-entity reference to a LinearTermDiscountCurve instance",
    role="attribute",
    category="fixed_income",
)

REGISTRY.define("discount_curve", object,
    description="Cross-entity reference to a discount LinearTermDiscountCurve instance",
    role="attribute",
    category="fixed_income",
    allowed_prefixes=["leg1", "leg2"],
)
...
REGISTRY.define("projection_curve", object,
    description="Cross-entity reference to a projection LinearTermDiscountCurve instance",
    role="attribute",
    category="fixed_income",
    allowed_prefixes=["leg1", "leg2"],
)
...
REGISTRY.define("zero_rate", float,
    description="Equivalent zero rate derived from integrated rate: R(t)/t",
    semantic_type="ratio",
    role="measure",
    unit="ratio",
    format=",.6f",
    display_name="Zero Rate",
    category="fixed_income",
)
